...
public class NotificationHelper extends ContextWrapper {
    ...
    public NotificationHelper(Context base) { super(base);
...
//membuka izin pengaturan dari aplikasi untuk memulai service notifikasi
    ...
    //builder yang akan membuat notifikasi tampil
        ...
        return new
                NotificationCompat.Builder(getApplicationContext(), channelID) .setContentTitle("Alarm!") .setContentText("Bangun Woi ") .setSmallIcon(R.drawable.ic_android);
    }
}
